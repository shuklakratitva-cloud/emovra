...
export default function Dashboard() {
  ...
  // Every nav item swaps to its OWN screen (see the activeTab checks below -
  // each one is a separate, mutually-exclusive block, nothing stacks below
  // another tab's content like the old version did). This just makes sure
  // that swap is actually visible: if you were scrolled down on one tab,
  // switching tabs jumps you back to the top of the new screen instead of
  // leaving you stranded mid-page looking at nothing.
  useEffect(() => {
      ...
      <div className="ev-shell">
        <aside className="ev-sidebar">
          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              <div key={item.id} className={`ev-nav-item${activeTab === item.id ? " active" : ""}`} onClick={() => setActiveTab(item.id)}>
          ...
          <div className="ev-sidebar-bottom">
            ...
            <div className={`ev-nav-item${activeTab === "settings" ? " active" : ""}`} onClick={() => setActiveTab("settings")}>
          ...
          {activeTab === "dashboard" && (
            <>
              ...
              <div className="ev-bento-row">
                <div className="ev-card ev-mini-card" onClick={() => setActiveTab("journal")}>
                ...
                <div className="ev-card ev-mini-card" onClick={() => setActiveTab("rituals")}>
              ...
              <div className="ev-bento-row">
                <div className="ev-card ev-mini-card" onClick={() => setActiveTab("sanctuary")}>
                ...
                <div className="ev-card" style={{ gridColumn: "span 1", cursor: "pointer" }} onClick={() => setActiveTab("companion")}>
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <button key={item.id} onClick={() => setActiveTab(item.id)} style={{
              ...
              gap: 2, padding: "6px 10px", color: activeTab === item.id ? "var(--text-h)" : "rgba(232,220,198,0.5)",
