    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div style={{ background: 'rgba(139,92,246,0.2)', padding: 12, borderRadius: 12, fontSize: 13, color: 'white' }}>
              🧠 Mood Analysis - Active
            </div>
            <div style={{ background: 'rgba(255,255,255,0.05)', padding: 12, borderRadius: 12, fontSize: 13, color: 'white' }}>
      ...
      >
        <div className="landing-card-dark" style={{ borderRadius: 16, padding: 20 }}>
          <h3 style={{ color: 'white', margin: 0, fontWeight: 800 }}>Emotion AI</h3>
        ...
        <div className="landing-card-dark" style={{ borderRadius: 16, padding: 20 }}>
          <h3 style={{ color: 'white', margin: 0, fontWeight: 800 }}>100% Private</h3>
          <p style={{ marginTop: 8, fontSize: 13, color: 'rgba(255,255,255,0.5)' }}>
        ...
        <div className="landing-card-dark" style={{ borderRadius: 16, padding: 20 }}>
          <h3 style={{ color: 'white', margin: 0, fontWeight: 800 }}>SOS Support</h3>
          <p style={{ marginTop: 8, fontSize: 13, color: 'rgba(255,255,255,0.5)' }}>
