...
export default function MindGuardApp() {
    ...
    try {
      ...
      if (token) {
        fetch(`${API}/data/my`, {
          ...
          .then(d => {
            if (Array.isArray(d) && d.length) setHistory(d.reverse().slice(-20));
          })
          .catch(() => {});
      }
    } catch {}
  ...
  async function handleAnalyze() {
    ...
    const redKeys = [
      ...
      "no one will know if i die", "want to kill", "murder", "slit", "choke",
      "mujhe marna hai", "marna hai mujhe", "mar jana hai", "mar jau",
      "jeena nahi hai", "khatam karna hai", "khud ko khatam", "khudkushi",
      "zindagi khatam", "marna chahta hu", "nahi jeena", "zindagi se tang",
      "life se tang", "pareshan hu marna", "i will kill him"
    ];
    ...
    if (redKeys.some(k => lower.includes(k))) {
      const forced = {
        ...
        advice: "You matter. Please reach out now.",
        isCrisis: true,
        text: inputText,
      ...
      try {
        ...
        if (
          ...
          result = {
            ...
            emotion: "happy",
            sentiment: "positive",
            reasons: ["positive keywords: happy"],
            advice: "",
    ...
    <>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <span style={{ fontSize: 12, opacity: 0.7, color: "var(--text)" }}>
            Hi, {user.name} {isAdmin && "👑"}
          </span>
            ...
            {analysis.riskLevel === "RED" && (
              ...
              >
                ...
                <div style={{ fontSize: 13, marginTop: 6 }}>
                  We noticed you're going through a tough time. You are not alone. If you need to talk, help is available.
                </div>
