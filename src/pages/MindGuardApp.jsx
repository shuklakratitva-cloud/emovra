  ...
  return (
    <>
      ...
      <div style={{ maxWidth: 720, margin: "18px auto", padding: "0 16px" }}>
          ...
          <div style={{ marginTop: 16 }}>
            {analysis.riskLevel === "RED" && (
              <div style={{ padding: 16, background: "#fef2f2", border: "2px solid #ef4444", borderRadius: 12, color: "#991b1b", marginBottom: 12 }}>
                ...
                <div style={{ fontSize: 13, marginTop: 6 }}>We noticed you're going through a tough time. You are not alone.</div>
                <div style={{ display: "flex", gap: 10, marginTop: 10, flexWrap: "wrap" }}>
                  ...
                  {user.emergencyPhone && (<a href={`tel:${user.emergencyPhone}`} style={{ padding: "10px 16px", background: "#dc2626", color: "#fff", borderRadius: 10, textDecoration: "none", fontWeight: 700 }}>Call SOS: {user.emergencyPhone}</a>)}
                </div>
              </div>
            )}
        ...
        <div style={{ marginTop: 40, padding: '16px', textAlign: 'center', fontSize: '11px', color: 'var(--text)', opacity: 0.6, borderTop: '1px solid var(--border)' }}>
