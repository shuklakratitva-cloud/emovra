...
export default function MindGuardApp() {
  ...
  async function handleAnalyze(){
    ...
    const lower=inputText.toLowerCase();
        const redKeys=[
      // English
      "i want to die","kill myself","end my life","suicide","no one will know if i die","want to kill","murder","slit","choke",
      // Hinglish / Hindi transliterated
      "mujhe marna hai","marna hai mujhe","mar jana hai","mar jau","jeena nahi hai","jeena nahi chahta","jeena nahi chahti",
      "khatam karna hai","khud ko khatam","khudkushi","atmahatya","life khatam karna hai","zindagi khatam",
      "marna chahta hu","marna chahti hu","nahi jeena","jeene ka man nahi","tired of life",
      // Hinglish frustration + death
      "zindagi se tang","life se tang","pareshan hu marna","bahut pareshan marna hai",
      // Abuse + self harm (common in India)
      "bc marna hai","mc marna hai","bkl marna hai"
    ];
